...
<!-- AUTO-LOG:START -->
<!-- Regenerated by running `node scripts/update-loop-log.js` — do not hand-edit this block, it will be overwritten next run. Last updated: 2026-09-09T19:46:40.546Z -->
...
- **PR #16** — two real, distinct bugs:
  ...
  - Then verified against the **live deployed page**, no mocks: this
    exact commit is the live end-to-end test — see the addendum below,
    added after actually watching it happen.
